...
for(f in 1:length(files)){
  ...
  pdf(paste0("/rds/projects/v/vianaj-genomics-brain-development/MATRICS/bismark_methylation_extractor/boxplots/MCC/CpG_coverage_distribution_",names(files)[[f]],"_boxplot.pdf"))
