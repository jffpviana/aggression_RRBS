...
# methylation plot
pdf(paste0("/rds/projects/v/vianaj-genomics-brain-development/MATRICS/bismark_methylation_extractor/boxplots/VMH/smooth_methylation__levels_VMH_plot.pdf"))
plot(mean.cByJ,
     mean.cJ,
     col = "blue",
