...
fisbatch_screen --ntasks 8 --time 1:0:0

#mkdir  /rds/projects/v/vianaj-genomics-brain-development/MATRICS/genome # create folder

cd /rds/projects/v/vianaj-genomics-brain-development/MATRICS/genome # change directory
