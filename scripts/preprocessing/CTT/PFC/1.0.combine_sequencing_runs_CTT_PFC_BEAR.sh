...
mv /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTT/PFC/CB2DBANXX/* /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTT/PFC/combined

for fasta in /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTT/PFC/combined/*.fastq
do
	file=`basename $fasta`
...
for fasta in /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTT/PFC/CB2N2ANXX/*.fq
do
	file=`basename $fasta`
	...
	file1=`ls /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTT/PFC/CB2N2ANXX/*.fq | grep $name`
	file2=`ls /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTT/PFC/CB30KANXX/*.fq | grep $name`
