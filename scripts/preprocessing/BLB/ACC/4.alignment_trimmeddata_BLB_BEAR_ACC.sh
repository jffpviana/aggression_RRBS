...
bismark -N 1 --un --ambiguous --gzip -q --se $read1 --genome  /rds/projects/v/vianaj-genomics-brain-development/MATRICS/reference_files/mouse_genome/with_spikeins -o /rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/ACC/trim_galore_output
done
