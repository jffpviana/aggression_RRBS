...
#combine MCC samples with the same name :

for fasta in $(ls /rds/projects/v/vianaj-genomics-brain-development/MATRICS/raw_data_test/CB2N2ANXX/*.fq | grep BLB.*MCC)
do
	name=`basename $fasta`
 echo $fasta
 echo $name
