...
bismark -N 1 --un --ambiguous --gzip -q --se $read1 --genome  /rds/projects/v/vianaj-genomics-brain-development/MATRICS/rat_genome/with_spikeins -o /rds/projects/v/vianaj-genomics-brain-development/MATRICS/CTR/HPT/bismark_alignment/
done
