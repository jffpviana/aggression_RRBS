...
print("check3")
  ...
  # start pdf
  pdf(paste0("/rds/projects/v/vianaj-genomics-brain-development/MATTRICS/bismark_methylation_extractor/spikeins/plots/test_plots/", names(methylated_data)[[file]],"_spikeins_scatter.pdf")) #paste0() is a really handy function, you can create strings (without spaces, for strings with spaces see paste()).
